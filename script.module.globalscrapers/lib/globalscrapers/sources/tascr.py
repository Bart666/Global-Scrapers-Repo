...
class source:
    ...
    def __init__(self):
        ...
        self.tvsearch = 'https://torrentapi.org//pubapi_v2.php?app_id=resistance&mode=search&search_string=%s&category=tv&ranked=0&token=%s'
        self.msearch = 'https://torrentapi.org//pubapi_v2.php?app_id=resistance&mode=search&search_string=%s&category=movies&ranked=0&token=%s'
        self.tokenta = 'https://torrentapi.org//pubapi_v2.php?app_id=resistance&get_token=get_token'
